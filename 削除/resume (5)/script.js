        ...
        const encodingBlock = document.querySelector('.setting-block[autocomplete="off"]');
        const separatorBlock = document.querySelector('.setting-block:not([autocomplete="off"])');
