        ...
        exportCsvBtn.addEventListener('click', () => {
            ...
            try {
                ...
                const currentEncoding = getSelectedEncoding(); // 【修正】関数から現在の文字コードを取得
        ...
        function processFile(file) {//ファイル選択時、ファイル貼付け時呼び出される（テキスト貼付け時は呼び出されない）
            ...
            reader.readAsText(file, getSelectedEncoding());//reader.readAsText(file, 'UTF-8');
        }
           ...
           // モード切り替え要素の取得
            ...
            if (dropZone) {
                ...
                dropZone.addEventListener('drop', (e) => {
                    ...
                    // テキストファイルとして読み込み開始
                    reader.readAsText(file, getSelectedEncoding());//reader.readAsText(file, 'UTF-8'); //ファイル読込前に文字コード変換を行う
                });               
